...
import static fixture.given.LineRequestFixture.green;
import static fixture.given.LineRequestFixture.red;
import static fixture.given.LineRequestFixture.다른분당선;
import static fixture.given.LineRequestFixture.분당선;
import static fixture.given.LineRequestFixture.새로운지하철역_id;
import static fixture.given.LineRequestFixture.신분당선;
import static fixture.given.LineRequestFixture.지하철역_id;
...
import static fixture.then.LineThenFixture.노선_응답값_id_검사;
import static fixture.then.LineThenFixture.노선_응답값_노선색_검사;
import static fixture.then.LineThenFixture.노선_응답값_노선이름_검사;
import static fixture.then.LineThenFixture.노선_응답값_포함된_지하철역_크기_검사;
import static fixture.then.LineThenFixture.노선_응답값_포함된지하철역_id_검사;
import static fixture.then.LineThenFixture.노선목록_노선이름_포함_검사;
import static fixture.then.LineThenFixture.노선목록_조회시_생성한노선_id_포함_검사;
import static fixture.then.LineThenFixture.노선목록_크기_검사;
import static fixture.then.LineThenFixture.없는노선조회시_에러표출_검사;
import static fixture.when.StationApiFixture.지하철역_생성_요청;
import static fixture.when.LineApiFixture.지하철역_노선_단건_조회;
import static fixture.when.LineApiFixture.지하철역_노선_등록_요청;
...
import static fixture.when.LineApiFixture.지하철역_노선_삭제;
import static fixture.when.LineApiFixture.지하철역_노선_수정;
