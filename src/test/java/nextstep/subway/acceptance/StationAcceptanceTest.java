...
import static nextstep.subway.acceptance.StationSteps.deleteStationRequest;
import static nextstep.subway.acceptance.StationSteps.getStationsRequest;
...
class StationAcceptanceTest extends AcceptanceTest {
    ...
    void deleteStation() {
        // given
        ExtractableResponse<Response> createResponse = createStationRequest("강남역");

        // when
        String uri = createResponse.header("Location");
        ExtractableResponse<Response> response = deleteStationRequest(uri);
        // then
