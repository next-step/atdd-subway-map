...
public class SectionAcceptanceTest {
    ...
    private Long 구일_아이디;
    private Long 구로_아이디;
    private Long 신도림_아이디;
    private Long 영등포_아이디;

    private String 일호선 = "1호선";

    private int 구일_구로_거리 = 10;
    private int 구로_신도림_거리 = 15;
    private int 신도림_영등포_거리 = 13;
    ...
    public void setUp() {
        ...
        구일_아이디 = getId(stationCreationResponses.get(0));
        구로_아이디 = getId(stationCreationResponses.get(1));
        신도림_아이디 = getId(stationCreationResponses.get(2));
        영등포_아이디 = getId(stationCreationResponses.get(3));
    }
