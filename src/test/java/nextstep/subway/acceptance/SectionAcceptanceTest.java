...
class SectionAcceptanceTest {
     ...
     * Then 에러가 발생한다
     */
    @DisplayName("지하철 노선에 구간을 생성 시 노선의 하행 종점역과 새로운 구간의 상행역이 일치하지 않으면 에러가 발생한다.")
    @Test
     ...
     * Then 에러가 발생한다
     */
    @DisplayName("지하철 노선에 구간을 생성 시 새로운 구간의 하행역이 노선에 등록되어 있다면 에러가 발생한다.")
    @Test
     ...
     * Then 에러가 발생한다
     */
    @DisplayName("지하철 노선 구간에서 지하철역을 삭제 시 하행 종점역이 아니면 에러가 발생한다.")
    @Test
     ...
     * Then 에러가 발생한다
     */
    @DisplayName("지하철 노선 구간에서 지하철역을 삭제 시 상행 종점역과 하행 종점역만 있는 경우 에러가 발생한다.")
    @Test
