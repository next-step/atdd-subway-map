...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void createSection(){
        //given
        String upStationId = 지하철역_생성_요청("뚝섬역").jsonPath().getString("id");
        String downStationId = 지하철역_생성_요청("신도림역").jsonPath().getString("id");
        String newSectionDownStationId = 지하철역_생성_요청("문래역").jsonPath().getString("id");
        ...
        response = RestAssured
                ...
                .body(params)
                .when().post(response.header("location") + "/section")
