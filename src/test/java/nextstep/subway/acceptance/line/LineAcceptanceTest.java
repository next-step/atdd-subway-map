...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void 지하철_노선_목록_조회_테스트() {
        ...
        노선이_생성되어_있다(BUNDANG_LINE_NAME, BUNDANG_LINE_COLOR, BUNDANG_UP_STATION_NAME, BUNDANG_DOWN_STATION_NAME, DISTANCE);
        // when 지하철역 목록을 조회하면
        List<String> 노선명_목록 = 지하철_노선명_목록_조회();
    ...
    void 지하철_노선_조회() {
        ...
        노선이_생성되어_있다(SHIN_BUNDANG_LINE_NAME, SHIN_BUNDANG_LINE_COLOR, SHIN_BUNDANG_UP_STATION_NAME, SHIN_BUNDANG_DOWN_STATION_NAME, DISTANCE);
        // when 생성한 지하철 노선을 조회하면
        String lineName = 지하철_노선명_조회(노선_ID);
        // then 생성한 지하철 노선의 정보를 응답받을 수 있다.
