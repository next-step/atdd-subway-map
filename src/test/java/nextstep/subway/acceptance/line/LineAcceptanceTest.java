...
import static nextstep.subway.acceptance.station.StationSteps.지하철역_생성_후_ID_반환;
...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void 지하철_노선_생성() {
        // when 지하철 노선을 생성하면
        ExtractableResponse<Response> response = 지하철_노선_생성(SHIN_BUNDANG_LINE, RED_COLOR, 지하철역_생성_후_ID_반환(GANGNAM_STATION), 지하철역_생성_후_ID_반환(YUKSAM_STATION), DISTANCE);
        assertAll(
                // then 지하철 노선이 생성된다
    ...
    void 지하철_노선_목록_조회_테스트() {
        ...
        지하철_노선_생성(SHIN_BUNDANG_LINE, RED_COLOR, 지하철역_생성_후_ID_반환(GANGNAM_STATION), 지하철역_생성_후_ID_반환(YUKSAM_STATION), DISTANCE);
        지하철_노선_생성(BUNDANG_LINE, BLUE_COLOR, 지하철역_생성_후_ID_반환(GANGNAM_STATION), 지하철역_생성_후_ID_반환(YUKSAM_STATION), DISTANCE);
        // when 지하철역 목록을 조회하면
    ...
    void 지하철_노선_조회() {
        // given 지하철 노선을 생성하고
        ExtractableResponse<Response> createLine = 지하철_노선_생성(SHIN_BUNDANG_LINE, RED_COLOR, 지하철역_생성_후_ID_반환(GANGNAM_STATION), 지하철역_생성_후_ID_반환(YUKSAM_STATION), DISTANCE);
        // when 생성한 지하철 노선을 조회하면
