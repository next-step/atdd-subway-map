...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine2() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청(name, "bg-red-600", LocalTime.of(05, 30), LocalTime.of(23, 30), 5);
    ...
    void updateLine() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선_수정_요청(createResponse, "1호선", "bg-blue-600",
