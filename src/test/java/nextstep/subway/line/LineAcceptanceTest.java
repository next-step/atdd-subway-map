...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        ...
        LineRequest lineRequest = LineRequest.of(blueLineId, redLineId, 10);

        final ExtractableResponse<Response> 신분당선 = 지하철_노선_등록요청(lineRequest);
    ...
    void getLine() {
        ...
        final ExtractableResponse<Response> response = 지하철_노선_조회요청(redLineId);

        지하철_노선_조회됨(redLineId, response);
    }
