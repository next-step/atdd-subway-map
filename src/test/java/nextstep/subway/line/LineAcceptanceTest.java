...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void getLines() {
        // given
        LineRequest lineRequest1 = 지하철_노선_등록되어_있음("2호선", "green");
        ExtractableResponse<Response> createdResponse1 = 지하철_노선_생성_요청(lineRequest1);

        LineRequest lineRequest2 = 지하철_노선_등록되어_있음("1호선", "blue");
    ...
    private LineRequest 지하철_노선_등록되어_있음(String lineName, String lineColor) {
        return new LineRequest(lineName, lineColor);
    }
    ...
    private ExtractableResponse<Response> 지하철_노선_수정_요청(String lineName, String lineColor,
        ...
        LineRequest lineRequest = 지하철_노선_등록되어_있음(lineName, lineColor);
        String uri = createdResponse.header("Location");
        return RestAssured.given().log().all()
                .body(lineRequest)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
