...
import static nextstep.subway.station.StationAcceptanceTest.강남역;
import static nextstep.subway.station.StationAcceptanceTest.역삼역;
...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addSectionToLine() {
        ...
        // when
        ExtractableResponse<Response> addSectionResponse = 지하철_노선에_구간_등록_요청(lineId, new SectionRequest(station1Id, station2Id, 7));
        // then
