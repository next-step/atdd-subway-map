...
import static subway.fixture.StationFixture.판교역_ID;
...
public abstract class SectionFixture {
    ...
    public static SectionRequest 양재역_판교역_구간_요청 =  SectionRequest.builder().upStationId(양재역_ID).downStationId(판교역_ID).distance(10).build();
    public static SectionRequest 강남역_양재역_구간_요청 =  SectionRequest.builder().upStationId(강남역_ID).downStationId(양재역_ID).distance(10).build();
}
