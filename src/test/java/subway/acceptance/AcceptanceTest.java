...
import static subway.common.fixture.FieldFixture.역_아이디;
...
public class AcceptanceTest {
    ...
    public static ExtractableResponse<Response> 지하철_구간_삭제_요청(String lineId, String downStationId) {
        return given(기본_헤더값_설정()).log().all()
                    .queryParam(역_아이디.필드명(), downStationId)
                .when().delete(SECTION_BASE_URL, lineId)
                .then().log().all()
                    .extract();
    }
}
