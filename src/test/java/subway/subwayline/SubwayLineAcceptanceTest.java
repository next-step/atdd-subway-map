...
import static subway.subwayline.SubwayLineSteps.*;
...
class SubwayLineAcceptanceTest extends ApiTest {
    ...
    void createSubwayLine() {
        ...
        CreateSubwayLineRequest subwayLineRequest = 지하철노선등록요청_생성(name, color, upStationId, downStationId, distance);
    ...
    void modifySubwayLine() {
        ...
        Long downStationId = 역_생성(stationName2);
        Long 지하철_노선_ID = 지하철_노선_생성(subwayLineName, color, distance, upStationId, downStationId);
        ModifySubwayLineRequest request = 지하철노선수정요청_생성(modifysubwayLineName, modifyColor);
    ...
    private void 지하철_노성_생성_검증(String stationName1, String stationName2, int distance, Long upStationId, Long downStationId, CreateSubwayLineRequest subwayLineRequest, ExtractableResponse<Response> response) {
