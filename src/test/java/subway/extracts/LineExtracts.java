...
public class LineExtracts {
    public static List<String> 지하철노선_목록_조회_응답_ID_추출(ExtractableResponse<Response> response) {
    ...
    public static List<String> 지하철노선_조회_역_ID_추출(ExtractableResponse<Response> response) {
        return response.body().jsonPath().getList("stations.id", String.class);
    }

    public static String 지하철노선_생성_응답_ID_추출(ExtractableResponse<Response> response) {
