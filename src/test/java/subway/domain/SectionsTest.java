...
class SectionsTest {
    ...
    @Test
    void addSection() {
        final Line 노선_신분당선 = 노선_등록(1L, 신분당선, 빨간색, 강남역, 양재역, 10);
    ...
    void error_addSection() {
        ...
        final Sections 구간들 = 노선_신분당선.getSections();
        assertThatThrownBy(() -> 구간들.addSection(노선_신분당선, 검암역, 몽촌토성역, 10))
    ...
    void error_addSection_2() {
        ...
        assertThatThrownBy(() -> 구간들.addSection(노선_신분당선, 양재역, 검암역, 10))
                .isInstanceOf(NoRegisterStationException.class)
                .hasMessage(NO_REGISTER_UP_STATION.getMessage());
    }
