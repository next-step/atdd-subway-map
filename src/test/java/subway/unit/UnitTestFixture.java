...
public class UnitTestFixture {
    ...
    public static final Line 신분당선 = new Line("신분당선", "bg-red-600", 강남역, 역삼역, 10);
    public static final Line 분당선 = new Line("분당선", "bg-red-500", 강남역, 역삼역, 10);

    public static final Stations 강남역_역삼역 = new Stations(List.of(강남역, 역삼역), 15);
    public static final Stations 강남역_역삼역_선릉역 = new Stations(List.of(강남역, 역삼역, 선릉역), 15);

    public static Stations 지하철역_리스트_생성(Station upStation, Station downStation) {
        return new Stations(List.of(upStation, downStation), 15);
    }
}
