...
public class SubwayFixture {
    ...
    public static final SubwayLineRequest LINE_SHIN_BUN_DANG_REQUEST = new SubwayLineRequest(
        "신분당선", "bg-red-600", 2L, 3L, 10);
    public static final SubwayLineRequest LINE_TWO_REQUEST = new SubwayLineRequest(
        "2호선", "bg-green-600", 2L, 3L, 5);
    public static final SubwayLineRequest LINE_NEW_SHIN_BUN_DANG_REQUEST = new SubwayLineRequest(
