...
public class LineAcceptanceTest {
    ...
    void createLine() {
        ...
        ExtractableResponse<Response> createResponse = LineResponse.createLineResponse(line1);

        // then
        assertThat(createResponse.statusCode()).isEqualTo(HttpStatus.CREATED.value());

        // then
        ExtractableResponse<Response> response = LineResponse.getLinesResponse();
    ...
    void showLines() {
        ...
        Map<String, Object> line1 = createLine("신분당선", "bg-red-600", 1, 2, 10);
        LineResponse.createLineResponse(line1);
        Map<String, Object> line2 = createLine("분당선", "bg-red-600", 1, 3, 10);
        LineResponse.createLineResponse(line2);
    ...
    void showLine() {
        ...
        createStation("새로운 지하철역");
        Map<String, Object> line1 = createLine("신분당선", "bg-red-600", 1, 2, 10);
        ExtractableResponse<Response> lineResponse = LineResponse.createLineResponse(line1);
        long id = lineResponse.response().jsonPath().getLong("id");

        //when
        ExtractableResponse<Response> response = LineResponse.getLineResponse(id);
    ...
    void updateLine() {
        ...
        ExtractableResponse<Response> updatedResponse = LineResponse.updateLineResponse(updateInfoParam, id);
    ...
    void deleteLine() {
        ...
        //when
        ExtractableResponse<Response> response = LineResponse.deleteLineResponse(id);
    ...
    private void createStation(String stationName) {
        ...
        StationResponse.createStationResponse(station);
    }
}
