...
public class LineAcceptanceTest {
    ...
    public LineAcceptanceTest(final StationRepository stationRepository) {
    ...
    void setUp() {
        ...
        lineRepository.truncateTableLine();
    ...
    void createLine() {
        ...
        Assertions.assertAll(
                ...
                () -> assertThat(jsonPath.getList("stations.upStationId")).contains(upStationId),
                () -> assertThat(jsonPath.getList("stations.downStationId")).contains(downStationId),
    ...
    private static void createLine(final String name, final String color, final Long upStationId,
