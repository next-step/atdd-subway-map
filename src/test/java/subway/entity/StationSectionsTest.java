...
public class StationSectionsTest {
    ...
    @Nested
    class 모든_구간의_상행역과_새로운_구간의_하행역과_비교 {
    ...
    class 마지막_역_찾기 {
        ...
        /**
         * Given 지하철 구간이 생성되고, 2개의 구간이 추가된다.
         * When  지하철 구간의 마지막 역을 조회하면
         * Then  지하철 구간의 마지막 역을 반환한다.
         */
        @Test
        void 기존_지하철_구간의_마지막_역_조회() {
            // given
            StationSections 구간_목록 = new StationSections();
            ...
            // when
            Long lastStationId = 구간_목록.findLastStationId();

            // then
            assertThat(lastStationId).isEqualTo(논현_신논현_구간.getDownStationId());
        }
    }
}
