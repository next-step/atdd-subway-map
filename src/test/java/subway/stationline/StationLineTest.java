...
public class StationLineTest {
    ...
    @BeforeEach
    void setUp() {
        stationLine = new StationLine("테스트라인", "red", 1L, 2L, 10L);
    }
...
//        stationLine.extendLine(new StationLine(null, null, 2L, 3L, 20L));
        ...
        assertThat(stationLine.getUpStationId()).isEqualTo(1L);
        assertThat(stationLine.getDownStationId()).isEqualTo(3L);
        assertThat(stationLine.getDistance()).isEqualTo(30L);
    }
