...
class LineCreateRequestTest {
    ...
    void lineCreateRequestCreateTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "color", 1L, 2L, 3);
    ...
    void lineCreateRequestNameIsEmptyTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("", "color", 1L, 2L, 3);
    ...
    void lineCreateRequestColorIsEmptyTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "", 1L, 2L, 3);
    ...
    void lineCreateRequestUpStationIsNullTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "color", null, 2L, 3);
    ...
    void lineCreateRequestDownStationIsNullTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "color", 1L, null, 3);
    ...
    void lineCreateRequestDistanceIsLoeZeroTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "color", 1L, 2L, 0);
    ...
    void lineCreateRequestUpStationSameWithDownStationTest() {
        final LineCreateRequest lineCreateRequest = new LineCreateRequest("name", "color", 1L, 1L, 3);
