...
import static nextstep.subway.error.ErrorCode.DOWN_STATION_MUST_NOT_CURRENTLY_REGISTERED_STATION_ERROR;
import static nextstep.subway.error.ErrorCode.FIRST_SECTION_CREATE_ERROR;
import static nextstep.subway.error.ErrorCode.ONLY_THE_LAST_SECTION_CAN_BE_DELETE_ERROR;
import static nextstep.subway.error.ErrorCode.SECTION_MINIMUM_SIZE_ERROR;
import static nextstep.subway.error.ErrorCode.UP_STATION_MUST_SAME_LAST_REGISTERED_DOWN_STATION_ERROR;
