...
public class LineResponse {
    ...
    public static LineResponse of(Line line) {
        List<StationResponse> stations = line.getAllLineStations().stream().map(StationResponse::of).collect(Collectors.toList());
    ...
    public List<StationResponse> getStations() {return this.stations;}
