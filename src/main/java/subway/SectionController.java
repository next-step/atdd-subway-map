...
public class SectionController {
    ...
    public ResponseEntity<?> createSections(@PathVariable Long id, @RequestBody SectionCreateRequest request) throws HttpException {
    ...
    public ResponseEntity<SectionResponse> readSections(@PathVariable Long id) throws HttpException {
        SectionResponse sectionResponse = sectionFacade.readSections(id);
        return ResponseEntity.ok(sectionResponse);
    }

    @DeleteMapping("/lines/{id}/sections")
    public ResponseEntity<?> deleteSections(@PathVariable Long id, @RequestParam Long stationId) throws HttpException {
