...
public class SectionRegister {
    ...
    public void registSectionInLine(Set<Station> stations, Line line, Section newSection) {
        checkStationsInLine(stations, line);
        validateNewSectionDownStationNotInExistingInStations(stations, newSection);
