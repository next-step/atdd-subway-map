...
import subway.domain.line.entity.Sections;
import subway.domain.station.StationInfo;
...
public class LineInfo {
    ...
    public static class Sections {
        ...
        public static Sections from(subway.domain.line.entity.Sections entity) {
    ...
    public static class Section {
        ...
        public static Section from(subway.domain.line.entity.Section entity) {
