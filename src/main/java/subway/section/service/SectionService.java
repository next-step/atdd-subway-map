...
public class SectionService {
    ...
    public SectionDto enroll(long lineId, SectionDto sectionDto) {
        ...
        validateEnrollment(line, newSection);
    ...
    public void deleteSection(long lineId, long stationId) {
        ...
        // 노선의 마지막 역인지 확인한다
        Line line = getLine(lineId);
        validateDeletion(stationId, deleteReqStation, line);
    ...
    private void validateEnrollment(Line line, Section newSection) {
    ...
    private void validateDeletion(long stationId, Station deleteReqStation, Line line) {
        // 마지막 구간 아닌 구간 제거한 경우
