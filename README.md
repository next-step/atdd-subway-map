...
- [ ] 인수 조건을 검증하는 인수 테스트를 작성하세요.
  - 지하철 노선 구간 등록
    - [ ] 지하철 노선 구간 등록 인수테스트 작성
  - 지하철 노선 제거 등록
    - [ ] 지하철 노선에 구간을 제거 인수테스트 작성
- [ ] 예외 케이스에 대한 검증도 포함하세요.
  - 지하철 노선 구간 등록
    - [ ] 지하철 노선 구간이 새로운 구간의 상행선이 기존 하행 종점역이 아닐경우 예외발생 인수테스트 작성
    - [ ] 새로운 구간의 하행역은 해당 노선에 등록되어있는 역일 수 없다 인수테스트 작성
    - [ ] 지하철 노선에 추가되는 지하철역이 등록되어 있지 않을 경우 예외 발생 인수테스트 작성
  - 지하철 노선 제거 등록
    - [ ] 지하철 노선에 마지막 구간이 아닌 구간을 제거시 예외발생 인수테스트 작성
    - [ ] 지하철 노선에 상행 종점역과 하행 종점역만 있을 경우 삭제 시 예외 발생 인수테스트 작성
- [ ] 기존 인수테스트 및 코드 리팩토링
